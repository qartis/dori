...
volatile uint8_t slow_ring[512];
volatile uint16_t slow_ring_in;
volatile uint16_t slow_ring_out;

/* bytes to be output on the fast (hardware uart) side */
volatile uint8_t fast_ring[512];
volatile uint16_t fast_ring_in;
volatile uint16_t fast_ring_out;
